...
if (!process.env.POSTGRES_URL) {
  process.env.POSTGRES_URL = process.env.NEON_URL || process.env.DATABASE_URL || process.env.NEON_POSTGRES_URL || process.env.NEON_DATABASE_URL || '';
}

const isPostgres = Boolean(process.env.POSTGRES_URL || process.env.DATABASE_URL || process.env.NEON_URL);
